 ...
 #define SA_MESSAGE_0		"Empieza la construcción del Destructor"
 #define SA_MESSAGE_1		"Tiempo restante - 1.5 minutos"
 #define SA_MESSAGE_1_1		"Tiempo restante - 1 minuto 20 segundos"
 #define SA_MESSAGE_1_2		"Tiempo restante - 1 minutos 10 segundos"
 #define SA_MESSAGE_2		"Tiempo restante - 1 minutos"
 #define SA_MESSAGE_3		"Tiempo restante - 50 segundos"
 #define SA_MESSAGE_4		"Tiempo restante - 40 segundos"
 #define SA_MESSAGE_5		"Tiempo restante - 30 segundos"
 #define SA_MESSAGE_6		"Tiempo restante - 20 segundos"
 #define SA_MESSAGE_7		"Tiempo restante - 10 segundos"
